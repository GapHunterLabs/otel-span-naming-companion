package dev.gaphunter.otelspannamingcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.otelspannamingcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.otelspannamingcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "OTel Span Naming Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33797-otel-span-naming-companion/reviews"
